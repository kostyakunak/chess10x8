  ...
  return (
    <div className="bg-emerald-900/20 backdrop-blur rounded-2xl border border-emerald-700/30 shadow-xl p-4 space-y-4">
      ...
      <div className="space-y-2">
        <button
          onClick={onFlipBoard}
          className="w-full px-4 py-2 bg-amber-500 hover:bg-amber-600 text-slate-900 font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="w-full px-4 py-2 bg-amber-500 hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed text-slate-900 font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
        >
